...
ROOT_DIR = r"C:\Users\sidha\Desktop\model"
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        annotations1 = json.load(open(r'C:\Users\sidha\Desktop\model\dataset\train'))
        # print(annotations1)
...
def train(model):
    ...
    dataset_train.load_custom(r"C:\Users\sidha\Desktop\model\dataset\train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom(r"C:\Users\sidha\Desktop\model\dataset\valid")
    dataset_val.prepare()
